...
#[cfg(windows)]
pub use windows::{
    BridgeError, Enrollment, EnrollmentError, OperationId, ParentWindow, ProtectedStateError,
    cancel, delete_user_file_by_handle, enroll, evaluate, is_available, protect_user_state, remove,
